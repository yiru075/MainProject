  ...
  <div style={{ padding: '2rem', maxWidth: 800, margin: '0 auto' }}>
    <Card>
      <Typography>
        ...
        <Paragraph>
          Healthy eating isn’t about fancy food or dieting. It’s about choosing foods that give your body the energy,
          strength, and protection it needs — especially when you’re 40 and beyond.
        </Paragraph>
        ...
        <Paragraph><Text strong>“After 40, Your Body Needs...”</Text></Paragraph>

        <Divider orientation="left">Helpful Links</Divider>
        <ul>
          <li>
            <Link href="https://www.eatforhealth.gov.au/" target="_blank">Eat For Health – Australian Dietary Guidelines</Link> – This official Australian government website helps you:
            <ul>
          ...
          <li>
            <Link href="https://www.healthdirect.gov.au/nutrition" target="_blank">HealthDirect – Nutrition After 40</Link> – Learn:
            <ul>
          ...
          <li>
            <Link href="https://nutritionaustralia.org/" target="_blank">Nutrition Australia – Culturally Diverse Nutrition Tips</Link> – Offers:
            <ul>
        ...
        <Paragraph>
          Fatima, 59, often skipped meals when money was tight. She started including lentils, frozen vegetables, and oats in her weekly plan —
          all cheap, filling, and good for her health. She now feels more energetic and spends less.
        </Paragraph>

        <Divider orientation="left">Key Takeaway</Divider>
        <Paragraph>
          <Text strong>After 40, your body needs more support from food — and small changes can make a big difference. You don’t need to spend a lot to eat well.</Text>
        </Paragraph>
      </Typography>
    </Card>
  </div>
