...
const Topic1_1 = () => {
  return (
    <div style={{ padding: '2rem', maxWidth: 800, margin: '0 auto' }}>
      <Card>
        <Typography>
          <Title level={2}>Module 1 – Topic 1: What is Superannuation and Why It Matters</Title>
          ...
          <Paragraph>
            Superannuation (or super) is money that’s saved for you by your employer while you're working.
            This money is kept in a special account — and you can access it when you retire.
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph><Text strong>Super in 3 Simple Steps</Text></Paragraph>
          ...
          <ul>
            <li>
              ...
              </Link> – This government page explains super in very simple terms:
              <ul>
            ...
            <li>
              ...
              </Link> – This page gives visual guides and examples of how super grows:
              <ul>
            ...
            <li>
              ...
              </Link> – If you don’t have much super, this page explains:
              <ul>
          ...
          <Paragraph>
            Amina, 54, thought she didn’t have super because she worked casually. But when she signed in to MyGov,
            she found a super fund from a job years ago — with $3,000 in it. That small amount gave her hope. Now she checks it every few months.
          </Paragraph>

          <Divider orientation="left">Key Takeaway</Divider>
          <Paragraph>
            Super is your money for later. Even if you worked casually or took a break to care for family, you may still have it.
            And it’s never too late to learn more.
          </Paragraph>
        </Typography>
      </Card>
    </div>
