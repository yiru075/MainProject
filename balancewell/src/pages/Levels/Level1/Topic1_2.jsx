    ...
    <div style={{ padding: '2rem', maxWidth: 800, margin: '0 auto' }}>
      <Card>
        <Typography>
          ...
          <Paragraph><Text strong>Financial Literacy Is…</Text></Paragraph>
          ...
          <ul>
            <li>
              <Link href="https://moneysmart.gov.au/" target="_blank">
            ...
            <li>
              <Link href="https://goodshep.org.au/" target="_blank">
            ...
            <li>
              ...
              <ul>
                <li>Free phone and online support for people struggling with money</li>
                <li>Talk to a financial counsellor</li>
                <li>Help with bills or debt</li>
          ...
          <Paragraph>
            Financial literacy doesn’t mean knowing everything. It means understanding enough to make decisions,
            feel secure, and avoid stress. And you can start learning today.
          </Paragraph>
        </Typography>
      </Card>
    </div>
