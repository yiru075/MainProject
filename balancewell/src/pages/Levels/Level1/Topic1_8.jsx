  ...
  <div style={{ padding: '2rem', maxWidth: 800, margin: '0 auto' }}>
    <Card>
      <Typography>
        ...
        <Paragraph>
          You don’t have to face money, stress or life worries alone.
          There are free, safe places in Australia that help people:
        </Paragraph>
        <ul>
        ...
        <Paragraph><Text strong>“Trusted Places You Can Turn To”</Text></Paragraph>

        <Divider orientation="left">Helpful Links (With Explanation)</Divider>
        <ul>
          <li>
            <Link href="https://ndh.org.au/" target="_blank">National Debt Helpline – 1800 007 007</Link> – Talk to a free financial counsellor.
            <ul>
          ...
          <li>
            <Link href="https://askizzy.org.au/" target="_blank">Ask Izzy – Support Services Near You</Link> – A website that shows where to find:
            <ul>
          ...
          <li>
            <Link href="https://www.servicesaustralia.gov.au/" target="_blank">Services Australia – Payments & Help</Link> – Learn about:
            <ul>
        ...
        <Paragraph>
          Ravi, 56, was behind on rent and too embarrassed to ask for help. A friend showed him Ask Izzy — he found a local service
          that helped him talk to his landlord, apply for rent assistance, and get groceries. He says:
        </Paragraph>
        <Paragraph>
          “They listened, and I didn’t feel ashamed. I wish I’d asked earlier.”
        </Paragraph>

        <Divider orientation="left">Key Takeaway</Divider>
        <Paragraph>
          <Text strong>There is no shame in asking for help. Australia has free services ready to support your money, health, and housing — and many are designed for multicultural communities.</Text>
        </Paragraph>
      </Typography>
    </Card>
  </div>
